...
Version  : 0.18
Release  : 31
URL      : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/List-AllUtils-0.18.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/List-AllUtils-0.18.tar.gz
...
%prep
%setup -q -n List-AllUtils-0.18
cd %{_builddir}/List-AllUtils-0.18
...
cp %{_builddir}/List-AllUtils-0.18/LICENSE %{buildroot}/usr/share/package-licenses/perl-List-AllUtils/5586816d65cedc4c52fb3e6704d529fb9535d8fe
if test -f Makefile.PL; then
